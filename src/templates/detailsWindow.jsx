...
import InfoBar from '../surfaces/infoBar';
...
class DetailsWindow extends React.PureComponent {
    constructor() {
        super();
...
DetailsWindow.propTypes = propTypes;
DetailsWindow.defaultProps = defaultProps;
