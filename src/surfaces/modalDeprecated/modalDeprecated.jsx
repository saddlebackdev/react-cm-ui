...
import ModalHeader from './modalDeprecatedHeader';
...
ModalDeprecated.propTypes = propTypes;
ModalDeprecated.defaultProps = defaultProps;

export default withStyles(styles, { withTheme: true })(ModalDeprecated);
