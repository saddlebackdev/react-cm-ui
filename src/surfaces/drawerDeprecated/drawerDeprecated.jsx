...
import HeaderDeprecated from '../../dataDisplay/headerDeprecated';
...
class DrawerDeprecatedHeader extends React.Component {
    constructor() {
        super();
        ...
        return (
            <header className="drawer-header" ref={ref => this._drawerHeaderRef = ref}>
                {_.isObject(title) ? (
                    ...
                    <HeaderDeprecated as="h2" className={titleClass} title={title}>
                        {title}
                    </HeaderDeprecated>
                ) : null}
