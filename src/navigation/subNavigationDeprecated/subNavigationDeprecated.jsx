...
import SubNavigationDeprecatedItem from './subNavigationDeprecatedItem';
...
class SubNavigationDeprecated extends React.Component {
    constructor(props) {
        super(props);
...
SubNavigationDeprecated.Item = SubNavigationDeprecatedItem;

SubNavigationDeprecated.propTypes = propTypes;
SubNavigationDeprecated.defaultProps = defaultProps;

export default SubNavigationDeprecated;
