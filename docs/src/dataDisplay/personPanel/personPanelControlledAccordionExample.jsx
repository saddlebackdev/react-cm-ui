        ...
        const mappedData = map(PAYLOAD_PERSON, (person) => {
            ...
            return {
                ...
                details: {
                    ...
                    activate1Date: person.activate1Date,
                    activate2Date: person.activate2Date,
                    activate3Date: person.activate3Date,
                    activate4Date: person.activate4Date,
                    ...
                    hasAttendedActivate1: person.hasAttendedActivate1,
                    hasAttendedActivate2: person.hasAttendedActivate2,
                    hasAttendedActivate3: person.hasAttendedActivate3,
                    hasAttendedActivate4: person.hasAttendedActivate4,
