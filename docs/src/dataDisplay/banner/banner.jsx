...
export default class BannerSample extends React.Component {
    ...
    render() {
        return (
            <div>
                <Button onClick={this._onBannerNotification1Click.bind(this)} version={2}>Banner Notification 1</Button>

                <Button onClick={this._onBannerNotification2Click.bind(this)} version={2}>Banner Notification 2</Button>

                <Button onClick={this._onBannerNotification3Click.bind(this)} version={2}>Banner Notification 3</Button>
...
export default class OnAfterCloseSample extends React.Component {
    ...
    render() {
        return (
            <div>
                <Button onClick={this._onAcBannerClick.bind(this, 0)} version={2}>AC Banner 1</Button>
                <Button onClick={this._onAcBannerClick.bind(this, 1)} version={2}>AC Banner 2</Button>
                <Button onClick={this._onAcBannerClick.bind(this, 2)} version={2}>AC Banner 3</Button>
                <Button onClick={this._onAcBannerClick.bind(this, 3)} version={2}>AC Banner 4</Button>
...
export default class TypeSample extends React.Component {
    ...
    render() {
        return (
            <div>
                <Button onClick={this._onBannerTypeNotificationClick.bind(this)} version={2}>Notification Banner</Button>

                <Button onClick={this._onBannerTypeAlertClick.bind(this)} version={2}>Alert Banner</Button>
