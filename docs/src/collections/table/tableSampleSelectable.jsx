...
export default class SelectableTableSample extends React.Component {
    render() {
        return (
...
function TableSampleSelectable() {
    return (
        <React.Fragment>
            <Header anchor="selectable" size="large" style={{ marginTop: '55px' }} sub>
                Selectable Table
                <Header.Subheader>
...
export default TableSampleSelectable;
