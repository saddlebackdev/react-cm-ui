...
export default class DrawerWingSample extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Button onClick={this._onDrawerWingToggle} version={2}>Open Drawer Full of Wings</Button>
                ...
                <Drawer
                    ...
                    wing={
                        ...
                        >
                            {wingOpenType === 'blue' ? (
                                <div>
                                    <Button onClick={() => this._onOpenWing()} version={2}>Close Wing</Button>
                ...
                >
                    <Button onClick={this._onDrawerWingToggle} version={2}>Close Drawer</Button>
                    ...
                    <Button onClick={() => this._onOpenWing('white')} version={2}>White Wing</Button>

                    <Button onClick={() => this._onOpenWing('blue')} version={2}>Blue Wing</Button>

                    <Button onClick={() => this._onOpenWing('grey')} version={2}>Grey Wing</Button>
                </Drawer>
            </div>
        );
    }
