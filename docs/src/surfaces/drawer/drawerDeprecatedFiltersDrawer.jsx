...
const drawerFiltersDrawerSample = `import { Button, Drawer } '@saddlebackchurch/react-cm-ui';
import React from 'react';
        ...
        return (
            <div>
                ...
                >
                    ...
                    <Drawer.Content>
                        <Drawer.DeprecatedFiltersDrawer
                            isDirty={isDirty}
...
class ModulesDeprecatedDrawerFiltersDrawer extends React.Component {
    constructor(props) {
        super(props);
    ...
    _onFiltersDrawerToggle() {
        console.log('### _onFiltersDrawerToggle');
        const { isFiltersDrawerOpen } = this.state;
...
export default ModulesDeprecatedDrawerFiltersDrawer;
